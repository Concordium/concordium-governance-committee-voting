...
export const moduleReference: SDK.ModuleReference.Type = /*#__PURE__*/ SDK.ModuleReference.fromHexString('97b03db7ab4874bd599cc75a8ef94bfb04888432ffc2cfa5d7130407b713c679');

/** Client for an on-chain smart contract module with module reference '97b03db7ab4874bd599cc75a8ef94bfb04888432ffc2cfa5d7130407b713c679', can be used for instantiating new smart contract instances. */
class ModuleModule {
 ...
 * Construct a ModuleModule client for interacting with a smart contract module on chain.
 * This function ensures the smart contract module is deployed on chain.
 * @param {ModuleModule} moduleClient - The client of the on-chain smart contract module with referecence '97b03db7ab4874bd599cc75a8ef94bfb04888432ffc2cfa5d7130407b713c679'.
 * @throws If failing to communicate with the concordium node or if the module reference is not present on chain.
 * @returns {ModuleModule} A module client ensured to be deployed on chain.
 */
