...
/** Client for an on-chain smart contract module with module reference '18b940e137f66044881414d3a3dffc216f5cb53a47c920cc2af8749d9e483057', can be used for instantiating new smart contract instances. */
class ModuleModule {
 ...
 * Construct a ModuleModule client for interacting with a smart contract module on chain.
 * This function ensures the smart contract module is deployed on chain.
 * @param {ModuleModule} moduleClient - The client of the on-chain smart contract module with referecence '18b940e137f66044881414d3a3dffc216f5cb53a47c920cc2af8749d9e483057'.
 * @throws If failing to communicate with the concordium node or if the module reference is not present on chain.
 * @returns {ModuleModule} A module client ensured to be deployed on chain.
 */
...
/** Parameter type transaction for instantiating a new 'ccd_gc_election' smart contract instance */
export type CcdGcElectionParameter = {
...
/**
 * Construct Parameter type transaction for instantiating a new 'ccd_gc_election' smart contract instance.
 * @param {CcdGcElectionParameter} parameter The structured parameter to construct from.
 * @returns {SDK.Parameter.Type} The smart contract parameter.
 */
export function createCcdGcElectionParameter(parameter: CcdGcElectionParameter): SDK.Parameter.Type {
...
/**
 * Send transaction for instantiating a new 'ccd_gc_election' smart contract instance.
 * @param {ModuleModule} moduleClient - The client of the on-chain smart contract module with referecence '18b940e137f66044881414d3a3dffc216f5cb53a47c920cc2af8749d9e483057'.
 ...
 * @param {CcdGcElectionParameter} parameter - Parameter to provide as part of the transaction for the instantiation of a new smart contract contract.
 * @param {SDK.AccountSigner} signer - The signer of the update contract transaction.
 * @throws If failing to communicate with the concordium node.
 * @returns {SDK.TransactionHash.Type}
 */
export function instantiateCcdGcElection(moduleClient: ModuleModule, transactionMetadata: SDK.ContractTransactionMetadata, parameter: CcdGcElectionParameter, signer: SDK.AccountSigner): Promise<SDK.TransactionHash.Type> {
    return SDK.ModuleClient.createAndSendInitTransaction(
        moduleClient.internalModuleClient,
        SDK.ContractName.fromStringUnchecked('ccd_gc_election'),
        transactionMetadata,
        createCcdGcElectionParameter(parameter),
        signer
    );
}
