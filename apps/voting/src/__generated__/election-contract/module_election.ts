...
export const moduleReference: SDK.ModuleReference.Type = /*#__PURE__*/ SDK.ModuleReference.fromHexString('18b940e137f66044881414d3a3dffc216f5cb53a47c920cc2af8749d9e483057');
/** Name of the smart contract supported by this client. */
export const contractName: SDK.ContractName.Type = /*#__PURE__*/ SDK.ContractName.fromStringUnchecked('ccd_gc_election');

/** Smart contract client for a contract instance on chain. */
class CcdGcElectionContract {
...
/** Smart contract client for a contract instance on chain. */
export type Type = CcdGcElectionContract;

/**
 * Construct an instance of `CcdGcElectionContract` for interacting with a 'ccd_gc_election' contract on chain.
 ...
 * @returns {CcdGcElectionContract}
 */
export async function create(grpcClient: SDK.ConcordiumGRPCClient, contractAddress: SDK.ContractAddress.Type, blockHash?: SDK.BlockHash.Type): Promise<CcdGcElectionContract> {
    ...
    return new CcdGcElectionContract(
        grpcClient,
        contractAddress,
        genericContract
    );
...
/**
 * Construct the `CcdGcElectionContract` for interacting with a 'ccd_gc_election' contract on chain.
 * Without checking the instance information on chain.
 * @param {SDK.ConcordiumGRPCClient} grpcClient - The client used for contract invocations and updates.
 * @param {SDK.ContractAddress.Type} contractAddress - Address of the contract instance.
 * @returns {CcdGcElectionContract}
 */
export function createUnchecked(grpcClient: SDK.ConcordiumGRPCClient, contractAddress: SDK.ContractAddress.Type): CcdGcElectionContract {
    const genericContract = new SDK.Contract(grpcClient, contractAddress, contractName);
    return new CcdGcElectionContract(
        grpcClient,
        contractAddress,
 ...
 * @param {CcdGcElectionContract} contractClient The client for a 'ccd_gc_election' smart contract instance on chain.
 ...
 */
export function checkOnChain(contractClient: CcdGcElectionContract, blockHash?: SDK.BlockHash.Type): Promise<void> {
    return contractClient.genericContract.checkOnChain({moduleReference: moduleReference, blockHash: blockHash });
}

/** Parameter type for update transaction for 'registerVotes' entrypoint of the 'ccd_gc_election' contract. */
...
/**
 * Construct Parameter for update transactions for 'registerVotes' entrypoint of the 'ccd_gc_election' contract.
...
/**
 * Send an update-contract transaction to the 'registerVotes' entrypoint of the 'ccd_gc_election' contract.
 * @param {CcdGcElectionContract} contractClient The client for a 'ccd_gc_election' smart contract instance on chain.
 ...
 */
export function sendRegisterVotes(contractClient: CcdGcElectionContract, transactionMetadata: SDK.ContractTransactionMetadata, parameter: RegisterVotesParameter, signer: SDK.AccountSigner): Promise<SDK.TransactionHash.Type> {
...
/**
 * Dry-run an update-contract transaction to the 'registerVotes' entrypoint of the 'ccd_gc_election' contract.
 * @param {CcdGcElectionContract} contractClient The client for a 'ccd_gc_election' smart contract instance on chain.
 ...
 */
export function dryRunRegisterVotes(contractClient: CcdGcElectionContract, parameter: RegisterVotesParameter, invokeMetadata: SDK.ContractInvokeMetadata = {}, blockHash?: SDK.BlockHash.Type): Promise<SDK.InvokeContractResult> {
...
/** Error message for dry-running update transaction for 'registerVotes' entrypoint of the 'ccd_gc_election' contract. */
...
/**
 * Get and parse the error message from dry-running update transaction for 'registerVotes' entrypoint of the 'ccd_gc_election' contract.
...
/** Parameter type for update transaction for 'postElectionResult' entrypoint of the 'ccd_gc_election' contract. */
export type PostElectionResultParameter = Array<number | bigint>;

/**
 * Construct Parameter for update transactions for 'postElectionResult' entrypoint of the 'ccd_gc_election' contract.
...
/**
 * Send an update-contract transaction to the 'postElectionResult' entrypoint of the 'ccd_gc_election' contract.
 * @param {CcdGcElectionContract} contractClient The client for a 'ccd_gc_election' smart contract instance on chain.
 * @param {SDK.ContractTransactionMetadata} transactionMetadata - Metadata related to constructing a transaction for a smart contract.
 ...
 * @returns {SDK.TransactionHash.Type} Hash of the transaction.
 */
export function sendPostElectionResult(contractClient: CcdGcElectionContract, transactionMetadata: SDK.ContractTransactionMetadata, parameter: PostElectionResultParameter, signer: SDK.AccountSigner): Promise<SDK.TransactionHash.Type> {
    return contractClient.genericContract.createAndSendUpdateTransaction(
...
/**
 * Dry-run an update-contract transaction to the 'postElectionResult' entrypoint of the 'ccd_gc_election' contract.
 * @param {CcdGcElectionContract} contractClient The client for a 'ccd_gc_election' smart contract instance on chain.
 * @param {SDK.ContractAddress.Type | SDK.AccountAddress.Type} invokeMetadata - The address of the account or contract which is invoking this transaction.
 * @param {PostElectionResultParameter} parameter - Parameter to provide the smart contract entrypoint as part of the transaction.
 * @param {SDK.BlockHash.Type} [blockHash] - Optional block hash allowing for dry-running the transaction at the end of a specific block.
 ...
 * @returns {SDK.InvokeContractResult} The result of invoking the smart contract instance.
 */
export function dryRunPostElectionResult(contractClient: CcdGcElectionContract, parameter: PostElectionResultParameter, invokeMetadata: SDK.ContractInvokeMetadata = {}, blockHash?: SDK.BlockHash.Type): Promise<SDK.InvokeContractResult> {
    return contractClient.genericContract.dryRun.invokeMethod(
        SDK.EntrypointName.fromStringUnchecked('postElectionResult'),
        invokeMetadata,
        SDK.Parameter.toBuffer,
...
/** Error message for dry-running update transaction for 'postElectionResult' entrypoint of the 'ccd_gc_election' contract. */
...
/**
 * Get and parse the error message from dry-running update transaction for 'postElectionResult' entrypoint of the 'ccd_gc_election' contract.
 * Returns undefined if the result is not a failure.
 * @param {SDK.InvokeContractResult} invokeResult The result from dry-running the transaction.
...
/** Parameter type for update transaction for 'viewConfig' entrypoint of the 'ccd_gc_election' contract. */
export type ViewConfigParameter = SDK.Parameter.Type;

/**
 * Construct Parameter for update transactions for 'viewConfig' entrypoint of the 'ccd_gc_election' contract.
...
/**
 * Send an update-contract transaction to the 'viewConfig' entrypoint of the 'ccd_gc_election' contract.
 * @param {CcdGcElectionContract} contractClient The client for a 'ccd_gc_election' smart contract instance on chain.
 * @param {SDK.ContractTransactionMetadata} transactionMetadata - Metadata related to constructing a transaction for a smart contract.
 ...
 * @returns {SDK.TransactionHash.Type} Hash of the transaction.
 */
export function sendViewConfig(contractClient: CcdGcElectionContract, transactionMetadata: SDK.ContractTransactionMetadata, parameter: ViewConfigParameter, signer: SDK.AccountSigner): Promise<SDK.TransactionHash.Type> {
    return contractClient.genericContract.createAndSendUpdateTransaction(
...
/**
 * Dry-run an update-contract transaction to the 'viewConfig' entrypoint of the 'ccd_gc_election' contract.
 * @param {CcdGcElectionContract} contractClient The client for a 'ccd_gc_election' smart contract instance on chain.
 * @param {SDK.ContractAddress.Type | SDK.AccountAddress.Type} invokeMetadata - The address of the account or contract which is invoking this transaction.
 * @param {ViewConfigParameter} parameter - Parameter to provide the smart contract entrypoint as part of the transaction.
 * @param {SDK.BlockHash.Type} [blockHash] - Optional block hash allowing for dry-running the transaction at the end of a specific block.
 ...
 * @returns {SDK.InvokeContractResult} The result of invoking the smart contract instance.
 */
export function dryRunViewConfig(contractClient: CcdGcElectionContract, parameter: ViewConfigParameter, invokeMetadata: SDK.ContractInvokeMetadata = {}, blockHash?: SDK.BlockHash.Type): Promise<SDK.InvokeContractResult> {
    return contractClient.genericContract.dryRun.invokeMethod(
        SDK.EntrypointName.fromStringUnchecked('viewConfig'),
        invokeMetadata,
        SDK.Parameter.toBuffer,
...
/** Return value for dry-running update transaction for 'viewConfig' entrypoint of the 'ccd_gc_election' contract. */
...
/**
 * Get and parse the return value from dry-running update transaction for 'viewConfig' entrypoint of the 'ccd_gc_election' contract.
...
/** Parameter type for update transaction for 'viewElectionResult' entrypoint of the 'ccd_gc_election' contract. */
export type ViewElectionResultParameter = SDK.Parameter.Type;

/**
 * Construct Parameter for update transactions for 'viewElectionResult' entrypoint of the 'ccd_gc_election' contract.
...
/**
 * Send an update-contract transaction to the 'viewElectionResult' entrypoint of the 'ccd_gc_election' contract.
 * @param {CcdGcElectionContract} contractClient The client for a 'ccd_gc_election' smart contract instance on chain.
 * @param {SDK.ContractTransactionMetadata} transactionMetadata - Metadata related to constructing a transaction for a smart contract.
 ...
 * @returns {SDK.TransactionHash.Type} Hash of the transaction.
 */
export function sendViewElectionResult(contractClient: CcdGcElectionContract, transactionMetadata: SDK.ContractTransactionMetadata, parameter: ViewElectionResultParameter, signer: SDK.AccountSigner): Promise<SDK.TransactionHash.Type> {
    return contractClient.genericContract.createAndSendUpdateTransaction(
...
/**
 * Dry-run an update-contract transaction to the 'viewElectionResult' entrypoint of the 'ccd_gc_election' contract.
 * @param {CcdGcElectionContract} contractClient The client for a 'ccd_gc_election' smart contract instance on chain.
 * @param {SDK.ContractAddress.Type | SDK.AccountAddress.Type} invokeMetadata - The address of the account or contract which is invoking this transaction.
 * @param {ViewElectionResultParameter} parameter - Parameter to provide the smart contract entrypoint as part of the transaction.
 * @param {SDK.BlockHash.Type} [blockHash] - Optional block hash allowing for dry-running the transaction at the end of a specific block.
 ...
 * @returns {SDK.InvokeContractResult} The result of invoking the smart contract instance.
 */
export function dryRunViewElectionResult(contractClient: CcdGcElectionContract, parameter: ViewElectionResultParameter, invokeMetadata: SDK.ContractInvokeMetadata = {}, blockHash?: SDK.BlockHash.Type): Promise<SDK.InvokeContractResult> {
    return contractClient.genericContract.dryRun.invokeMethod(
        SDK.EntrypointName.fromStringUnchecked('viewElectionResult'),
        invokeMetadata,
        SDK.Parameter.toBuffer,
...
/** Return value for dry-running update transaction for 'viewElectionResult' entrypoint of the 'ccd_gc_election' contract. */
...
/**
 * Get and parse the return value from dry-running update transaction for 'viewElectionResult' entrypoint of the 'ccd_gc_election' contract.
 * Returns undefined if the result is not successful.
 * @param {SDK.InvokeContractResult} invokeResult The result from dry-running the transaction.
...
/** Error message for dry-running update transaction for 'viewElectionResult' entrypoint of the 'ccd_gc_election' contract. */
...
/**
 * Get and parse the error message from dry-running update transaction for 'viewElectionResult' entrypoint of the 'ccd_gc_election' contract.
 * Returns undefined if the result is not a failure.
 * @param {SDK.InvokeContractResult} invokeResult The result from dry-running the transaction.
