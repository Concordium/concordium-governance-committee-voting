...
/** Client for an on-chain smart contract module with module reference '3ed4b7e60a7d2e017f41a60a7bac9668809c8a6928294ab9812d2fd3fb99e6dd', can be used for instantiating new smart contract instances. */
class ModuleModule {
 ...
 * Construct a ModuleModule client for interacting with a smart contract module on chain.
 * This function ensures the smart contract module is deployed on chain.
 * @param {ModuleModule} moduleClient - The client of the on-chain smart contract module with referecence '3ed4b7e60a7d2e017f41a60a7bac9668809c8a6928294ab9812d2fd3fb99e6dd'.
 * @throws If failing to communicate with the concordium node or if the module reference is not present on chain.
 * @returns {ModuleModule} A module client ensured to be deployed on chain.
 */
...
export function createElectionParameter(parameter: ElectionParameter): SDK.Parameter.Type {
    ...
    const out = SDK.Parameter.fromBase64SchemaType(
        '',
        named0,
    );
    return out;
}
