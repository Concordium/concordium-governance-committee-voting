...
export type ElectionContractWorkerMessage =
    | WorkerMessage<ElectionContractWorkerTag.ParseConfig>
    | WorkerMessage<ElectionContractWorkerTag.ParseGuardians>
    | WorkerMessage<ElectionContractWorkerTag.ParseElectionResult>;
